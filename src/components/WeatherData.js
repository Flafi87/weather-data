...
const WeatherData = ({
  ...
  const refreshButton =
    slider === results ? null : (
      <button type="submit" onClick={() => changeResults(slider)}>
        Refresh
      </button>
    );
  return (
    <div className="data-page">
      <div className="header-data">
        ...
        <DataField
          ...
          unit="C°"
          onClick={() => changeGraph("groundTemp")}
        />
        ...
        <DataField
          ...
          unit="C°"
          onClick={() => changeGraph("CPUTemp")}
        />
        <DataField
          data={Humidity}
          text="Humidity:"
          unit="%"
          onClick={() => changeGraph("humidity")}
        />
        <br />
      </div>
      <DataField
        ...
        text=""
        color="#3399CC"
        additionalClass="time"
      />
      <div className="helper">
        Click on the data field in order to see the graph of it
      </div>
      Last {(slider / 30).toFixed(0)} hours
